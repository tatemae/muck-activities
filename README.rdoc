...
Models that can have activity feed should call 'include MuckActivities::Models::ActivityConsumer'
...
Create an activity model that 'include MuckActivities::Models::Activity':
...
=== Authorization
Adding 'include MuckActivities::Models::ActivityConsumer' to your model will add a simple 'can_view?' method:
