...
Models that can have activity feed should call 'MuckActivities::Models::ActivityConsumer'
...
=== Authorization
By default 'MuckActivities::Models::ActivityConsumer' will add a simple 'can_view?' method:
